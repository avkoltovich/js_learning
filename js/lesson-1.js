...
var initializeClock = function (endtime) {
  var timeInterval = setInterval(function () {
      ...
      couponTimerMin.innerText = ('0' + minutes).slice(-2);
      couponTimerMinMinimize.innerText = ('0' + minutes).slice(-2);
      couponTimerSec.innerText = ('0' + t.seconds).slice(-2);

      if (t.minutes > 15) {
          barWrapper.style = 'clip: auto;';
          barRightHalf.style = 'display: block;'
          barLeftHalf.style = 'transform: rotate(' + (minutes * 12) + 'deg);';
      }

      if (t.minutes <= 15) {
          barWrapper.style = 'clip: rect(0, 60px, 60px, 30px);';
          barRightHalf.style = 'display: none;';
          barLeftHalf.style = 'transform: rotate(' + (minutes * 12) + 'deg);';
      }
...
//     couponTimerMin.innerText = ('0' + t.minutes).slice(-2);
//     couponTimerMinMinimize.innerText = ('0' + t.minutes).slice(-2);
//     couponTimerSec.innerText = ('0' + t.seconds).slice(-2);
// };

var deadLine = 'February 19 2020 14:58:00 GMT+03:00';
